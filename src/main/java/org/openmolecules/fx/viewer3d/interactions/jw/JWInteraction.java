...
public class JWInteraction {
		...
		public JWInteraction(IPharmacophorePoint pp1, IPharmacophorePoint pp2, Interaction interaction, V3DMolecule fxmol1, V3DMolecule fxmol2, Parent parent) {
			mPP1 = pp1;
			mPP2 = pp2;
			mFXmol1 = fxmol1;
			mFXmol2 = fxmol2;
