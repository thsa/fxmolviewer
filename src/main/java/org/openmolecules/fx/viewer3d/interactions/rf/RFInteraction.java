...
public class RFInteraction {
	...
	public enum Interaction{NONE, HBOND, IONIC, OTHER};
	...
	private final RFInteraction.Interaction mInteraction;

	public RFInteraction(IPharmacophorePoint pp1, IPharmacophorePoint pp2, RFInteraction.Interaction interaction, V3DMolecule fxmol1, V3DMolecule fxmol2, Parent parent) {
		mPP1 = pp1;
		mPP2 = pp2;
		mFXmol1 = fxmol1;
		mFXmol2 = fxmol2;
	...
	private void create() {
		Color color = (mInteraction == RFInteraction.Interaction.HBOND) ? HBOND_COLOR
					: (mInteraction == Interaction.IONIC) ? IONIC_COLOR : OTHER_COLOR;
