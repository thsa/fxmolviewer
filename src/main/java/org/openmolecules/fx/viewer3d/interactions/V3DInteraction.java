...
public class V3DInteraction {
	...
	private final double mValue,mDistance,mStrength;
	private double mLength;
	private int mVisAtom1, mVisAtom2;
	private DashedRod mRod;
	private final Color mColor;

	public V3DInteraction(V3DInteractionPoint ip1, V3DInteractionPoint ip2, double value, double distance, double strength, Color color) {
		mIP1 = ip1;
		mIP2 = ip2;
		mVisAtom1 = -1;
		mVisAtom2 = -1;
	...
	public V3DInteractionPoint getInteractionPoint(int no) {
