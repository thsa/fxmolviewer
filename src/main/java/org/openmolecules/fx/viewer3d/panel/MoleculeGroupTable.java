...
public class MoleculeGroupTable {
	...
	private void initTable() {
		...
		*/
		...
		strucCol.setCellValueFactory(cellData -> new SimpleObjectProperty<>(cellData.getValue().getValue()));
		...
		if ((mPane.getV3DScene().getSettings() & V3DScene.SETTING_ROLE) != 0) {
			roleCol.setCellValueFactory(cellData -> new SimpleObjectProperty<>(cellData.getValue().getValue()));
			roleCol.setCellFactory((e) -> new RoleCell());
